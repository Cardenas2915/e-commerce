...
<header>
    <section class="hero">
        ...
        <ul class="nav_link  nav_link-menu">
            <li class="nav_items">
                <a href="#banner" class="nav_links"><i class='bx bxs-home bx-sm' ></i> Inicio</a>
            </li>
            <li class="nav_items">
            ...
            <li class="nav_items">
                <a href="Login/Login.html" class="nav_links"><i class='bx bxs-user-rectangle bx-sm' ></i>Iniciar Sesion</a>
            </li>
        ...
        <div class="about_main">
            <article class="about_icons">
                ...
                <p class="about_paragraph">$25000</p>
                    <button class="carrito"><img src="images/bxs-cart-add.svg" alt="" class="image-carrito">Añadir</button> 
            ...
            <article class="about_icons">
                ...
                <h3 class="about_tittle">Piña y papaya</h3>
